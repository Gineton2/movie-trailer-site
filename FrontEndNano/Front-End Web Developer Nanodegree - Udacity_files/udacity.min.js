...
!(a.isPaidInterested||a.isPaidEnrolled||a.isPaidGraduated)}}}]);angular.module("overview").controller("nanodegreePortal",["$scope","cacheVersion","nodes","$window","currentUser","dateTime","api","$timeout","$q","productState","modal",function(a,d,b,c,e,f,g,h,i,j,k){var l={};a.launchHangoutOnAir=function(a,b){k.activate(a).finally(function(){var a=$("#"+b),c=a.attr("src");a.attr("src","");a.attr("src",c)})};a.dismiss=function(){k.confirm()};var m=function(){var b=_.find(a.lessonKeys,function(b){return!a.lessonStates.completed[b]});l[b]=!0},p=function(a,b){return g.get("/users/me/nodestates",
{node_keys:a}).then(function(a){_.each(a.data.nodestates,function(a){b.completed[a.node_ref.key]=a.node_completed||b.completed[a.node_ref.key];b.visited[a.node_ref.key]=!0})})};a.toggleOpenLesson=function(a){l[a]=!l[a]};a.showOpenLesson=function(a){return l[a]};a.markLessonAsComplete=function(b,c){c=c||1;a.lessonStates.completed[b]=!0;l[b]=!1;m();var d={items:[{content_context:[{node_key:a.nanodegree.key,tag:"c-"},{node_key:b,tag:"l-"}],data:{model:"CompletedExperience",completion_context:"Student self-completed the lesson"},
occurrence_time:f.getCurrentAsUTC()}],current_time:f.getCurrentAsUTC()};return g.post("/activity?related_chain=true",d).then(function(a){return a},function(d){console.error("Error when trying to post activity. Response:");console.error(d);5>c&&(console.error("Retrying. Attempt "+c),h(function(){a.markAsComplete(b,c+1)}))})};a.enroll=function(b){e.enroll(b,"enrolled",!0).then(function(){a.disableCoursewareAction=!1;a.enrollRequestPending=!1;c.location.href="/course/viewer#!/c-"+c.encodeURIComponent(b)})};
a.nanodegreeKey=j.courseKey;a.loadingMessage="Loading projects";a.lessons=[];b.batchGet([a.nanodegreeKey],{depth:1}).then(function(c){a.loadingMessage="Checking Progress";a.courses={};a.nanodegree=c[a.nanodegreeKey];a.lessonKeys=_.pluck(a.nanodegree.steps_refs,"key");a.lessonKeys=_.filter(a.lessonKeys,function(a){return c[a]});a.lessons=_.map(a.lessonKeys,function(a){l[a]=!1;return c[a]});a.relatedCourses=_.pluck(a.nanodegree.overview_details.related_course_refs,"key");var d=a.relatedCourses;b.batchGet(d).then(function(b){_.each(d,
function(c){var d=b[c];if(d){var e=null,f=d.catalog_entry;f&&f._image&&(e=f._image.serving_url);a.courses[c]={key:c,imageUrl:e||"http://placeape.com/100/100",title:d.title||"Title for testing"}}})},function(a){console.warning("failed to fetch nodes"+a.data.error)});a.lessonStates={};a.lessonStates.completed={};a.lessonStates.visited={};i.all([b.state(a.nanodegreeKey,"me").then(function(b){b&&_.each(b.completed_descendant_node_refs,function(b){a.lessonStates.completed[b.key]=!0})}),p(a.lessonKeys,
a.lessonStates)]).then(function(){a.loadingMessage=null;m()});a.courseStates={};a.courseStates.completed={};a.courseStates.visited={};p(a.relatedCourses,a.courseStates)})}]);angular.module("overview").directive("courseEnrollmentActions",["cacheVersion","currentUser","groups","$location","dateTime","$window","adrollTracker","courseState","modal",function(a,d,b,c,e,f,g,h,i){return{restrict:"A",scope:{enrollmentActions:"="},templateUrl:"/templates/overview/course_enrollment_actions.html?"+a,controller:"enrollmentActionsHelper",link:function(a){a.courseState=h;a.currentHighlightedFeature=0;a.freeCourseActionDefaultSectionTitle="Access Course Materials";a.paidCourseActionDefaultSectionTitle=
