//The squareTester method in this RectangularShape class is suppose to take
//a Rectangle parameter and return a string.
//
...
//But the method has one runtime (logic) error and several compile-time errors.
//
//Your job is to find and correct the errors so the method works correctly.
//Do not remove any lines of code. Do not change anything that is not an error.
