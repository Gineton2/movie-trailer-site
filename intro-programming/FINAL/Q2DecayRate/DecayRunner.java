...
// You are provided with a class, Substance, that represents a radioacitve substance that
...
//
// The class has a getMass method that returns the current mass of the subtance.
//
...
public class DecayRunner
{
    public static void main(String[] args)
    {
        ...
        // to two decimal points. You can use printf format specifier "%.2f\n"
        // Stop when the current mass is less than half the original mass of the substance
        // TODO:  print the number of years it takes to reach thhat mass
